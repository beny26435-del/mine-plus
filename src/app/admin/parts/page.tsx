  ...
  return (
    <AdminShell>
      ...
      <div className="mt-6 grid gap-3">
        ...
        {!items.length ? <p className="rounded-2xl border border-silver bg-white p-5 text-sm leading-7 text-steel">هنوز قطعه‌ای ثبت نشده است. از دکمه «قطعه جدید» اولین قطعه را اضافه کنید.</p> : null}
      </div>
    </AdminShell>
  );
}
