...
const homepageCopy = {
  ...
  heroText:
    "اگر دنبال دستگاه، قطعه، تعمیر یا راه‌اندازی فارم هستید، اول مدل و شرایط کارتان را بررسی می‌کنیم؛ بعد موجودی، قیمت روز و مسیر درست را شفاف می‌گوییم.",
  storeTitle: "ماینر و قطعه را با خیال راحت‌تر انتخاب کنید",
  storeText:
    "قبل از خرید، سازگاری قطعه، سلامت دستگاه، مصرف برق و شرایط تحویل را چک می‌کنیم تا انتخابتان فقط بر اساس حدس و قیمت نباشد.",
  servicesTitle: "فروش، تعمیر و زیرساخت در یک مسیر مشخص",
  servicesText:
    "از انتخاب دستگاه تا تعمیر و آماده‌سازی فارم، تمرکز ما روی تصمیم‌های قابل اجراست؛ چیزی که با برق، فضا و بودجه شما جور دربیاید.",
  repairCtaTitle: "ماینر خطا می‌دهد یا هش‌ریت افت کرده؟",
  repairCtaText:
    "مدل دستگاه، توضیح خطا و اگر دارید عکس یا ویدیو بفرستید تا قبل از هر هزینه‌ای مسیر بررسی روشن شود.",
...
const staleCopy = new Set([
  "Mine Plus | فروش، تعمیر و راه‌اندازی فارم",
  "فروش ماینر، قطعات و راه‌اندازی فارم",
...
export default async function HomePage() {
  ...
  const departments: Array<{ title: string; text: string; href: string; Icon: LucideIcon }> = [
    { title: "خرید ماینر", text: "مدل، مصرف برق، سلامت دستگاه و شرایط تحویل را قبل از خرید با هم بررسی می‌کنیم.", href: "/miners", Icon: Cpu },
    { title: "قطعات و تجهیزات", text: "پاور، فن، کنترل‌برد و کابل را بر اساس مدل دقیق دستگاه انتخاب کنید، نه با حدس.", href: "/parts", Icon: PlugZap },
