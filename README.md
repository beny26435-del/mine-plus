...
نرخ دلار/تومان و قیمت برق به‌صورت ورودی کاربر هستند، چون بدون اتصال به منبع قابل اتکای رایگان، نمایش عدد تومانی خودکار می‌تواند گمراه‌کننده باشد. اگر APIهای زنده در دسترس نباشند، صفحه خطای شفاف نمایش می‌دهد و محاسبه فیک انجام نمی‌دهد.
...
NEXT_PUBLIC_MINE_PLUS_PHONE="09127023327"
NEXT_PUBLIC_MINE_PLUS_WHATSAPP_LINK="https://wa.me/989127023327"
UPLOAD_API_URL="http://YOUR_VPS_IP:4000/api/upload"
